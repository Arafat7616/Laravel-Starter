...
class GalleryController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return datatables::of($data)
                ->addColumn('image', function ($data) {
                    ...
                    return '<a href="' . route('backend.gallery.edit', $data) . '" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="' . route('backend.gallery.destroy', $data) . '"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['image', 'action'])
                ->make(true);
        } else {
            return view('backend.website.gallery.index');
        }
    }
    ...
    {
        return view('backend.website.gallery.edit', compact('gallery'));
    }
